        ...
        child: Column(
          children: [
            ...
            _contactCard(
              ...
              onTap: () =>
                  _launchUrl('https://wa.me/8801700000000'),
            ...
            _contactCard(
              ...
              onTap: () =>
                  _launchUrl('https://t.me/IslamicAppOfficial'),
              onCopy: null,
            ),
            const SizedBox(height: 12),
            _contactCard(
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              onPressed: () => _launchUrl(
                  'mailto:bugs@islamicapp.dev?subject=Bug Report'),
      ...
      child: Column(
        children: [
          ...
          const Text(
            ...
            style: TextStyle(
                color: _textLo, fontSize: 13, height: 1.7),
          ),
        ],
      ),
    );
