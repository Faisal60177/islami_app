  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: auth.isLoggedIn
          ? _signOutView(context, ref, auth)
          : _notLoggedInView(context),
    );
  }

  Widget _signOutView(BuildContext context, WidgetRef ref, authState) {
                  ...
                  Container(
                    ...
                    child: authState.photoUrl.isNotEmpty
                      ...
                      child: Image.network(
                        authState.photoUrl,
                        fit: BoxFit.cover,
                        errorBuilder: (_, __, ___) => _avatarFallback(authState.displayName),
                      ),
                    )
                        : _avatarFallback(authState.displayName),
                  ),
