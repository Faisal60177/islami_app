...
static const String _tokenUrl = 'https://oauth2.quran.foundation/oauth2/token';
...
Future<String> getValidToken() async {
  ...
  _expiryTime != null && now.isBefore(_expiryTime!);
...
Future<String> _fetchToken() async {
  ...
  try{
    ...
    final expiresIn = data['expire_in'] as int;
